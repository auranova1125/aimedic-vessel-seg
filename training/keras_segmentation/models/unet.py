...
from .basic_models import vanilla_encoder, vanilla_encoder2
...
def custom_unet(n_classes ,input_height, input_width):
    ...
    o = UpSampling2D((2,2), data_format=IMAGE_ORDERING)(o)
    o = concatenate([o,levels[-2]], MERGE_AXIS)
    ...
    o = UpSampling2D((2,2), data_format=IMAGE_ORDERING)(o)
    o = concatenate([o,levels[-3]], MERGE_AXIS)
    ...
    o = UpSampling2D((2,2), data_format=IMAGE_ORDERING)(o)
    o = concatenate([o,levels[-4]], MERGE_AXIS)
    ...
    o = UpSampling2D((2,2), data_format=IMAGE_ORDERING)(o)
    o = concatenate([o,levels[-5]], MERGE_AXIS)
